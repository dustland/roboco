...
echo -e "3. Run your first example with: python examples/tool/web_surf.py"

echo -e "\n${GREEN}=== Workspace Setup Complete ===${NC}"
echo -e "Your Roboco workspace is now ready to use."
echo -e "To get started:"
echo -e "1. Activate your virtual environment with: source .venv/bin/activate"
echo -e "2. Ensure you have set up your API keys in .env"
echo -e "3. Run your first example with: python examples/tool/web_surf.py" 