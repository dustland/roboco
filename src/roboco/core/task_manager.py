...
class TaskManager:
    ...
    def update_tasks_file(self, tasks_path: str, phases: List[Phase]) -> None:
        """Update the tasks.md file with the current status of tasks.
        ...
        try:
            ...
            logger.error(f"Error updating tasks file: {str(e)}")
