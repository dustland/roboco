...
def validate(tool_names):
    ...
    if not tool_names:
        click.echo("Usage: roboco tools validate <tool_name1> <tool_name2> ...")
        return
    ...
    if invalid:
        ...
        click.echo("\nRun 'roboco tools list' to see available tools")
...
def suggest(agent_name, description):
    ...
    if suggestions:
        ...
        click.echo("Run 'roboco tools list' to see all available tools")
