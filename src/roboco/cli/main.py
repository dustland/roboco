#!/usr/bin/env python3
"""
Universal Roboco CLI

Provides a unified command-line interface for all Roboco operations.
"""
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="roboco",
        description="🤖 Roboco - Multi-Agent Framework with Observability",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  roboco start                    # Start API server with observability
  roboco monitor                  # Start observability monitor (CLI)
  roboco monitor --web            # Start web dashboard
  roboco status                   # Show system status
  roboco example superwriter      # Run specific example
  
For more information, visit: https://github.com/dustland/roboco
        """
    )
    ...
    start_parser = subparsers.add_parser(
        ...
        description="Start the Roboco API server with full observability features"
    )
    ...
    status_parser = subparsers.add_parser(
        ...
        description="Display current status of Roboco components"
    )
    ...
    example_parser = subparsers.add_parser(
        ...
        description="Run a specific Roboco example by name"
    )
    ...
    version_parser = subparsers.add_parser(
        ...
        description="Display Roboco version and component information"
    )
    ...
    config_parser = subparsers.add_parser(
        ...
        description="Manage Roboco configuration"
    )
...
def show_status():
    ...
    try:
        ...
        print(f"   Start with: roboco start")
    except:
        print("🌐 API Server: 🔴 Not running")
        print("   Start with: roboco start")
    ...
    try:
        ...
        print("   Run 'roboco monitor --web' to start the modern dashboard")
...
def show_version():
    ...
    print("🤖 Roboco Version Information")
    print("=" * 35)
    
    try:
        # Try to get version from package
        import importlib.metadata
        version = importlib.metadata.version("roboco")
...
def init_config():
    ...
    print("🤖 Initializing Roboco Configuration")
    print("=" * 40)
    ...
    if not env_file.exists():
        env_content = """# Roboco Environment Variables
...
"""
    ...
    print("3. Run 'roboco status' to check configuration")
