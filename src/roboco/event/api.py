"""
Simple API for the Roboco event system.
...
async def publish_event(
    ...
    Example:
        ```python
        from roboco.event import publish_event
        from roboco.core.event import TaskStartEvent
...
def subscribe_to_events(
    ...
    Example:
        ```python
        from roboco.event import subscribe_to_events
...
def unsubscribe_from_events(subscription_id: str) -> bool:
    ...
    Example:
        ```python
        from roboco.event import unsubscribe_from_events
...
def get_event_stats() -> EventBusStats:
    ...
    Example:
        ```python
        from roboco.event import get_event_stats
...
def get_active_subscriptions() -> Dict[str, List[str]]:
    ...
    Example:
        ```python
        from roboco.event import get_active_subscriptions
...
async def get_event_system_health() -> Dict[str, Any]:
    ...
    Example:
        ```python
        from roboco.event import get_event_system_health
